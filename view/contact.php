...
<form class="form" action="app/contact/new" method="POST">
    ...
    <textarea class="input" name="message" id="message" placeholder="Your message" cols="30" rows="10" required></textarea>
    <input id="submit" type="submit" value="Contact me back !">
</form>